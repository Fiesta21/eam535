CREATE OR REPLACE PACKAGE XXPHA_eam536_PKG IS
/* $Id: XX_eam536_PKG.sql 1.0 xx/xx/xxxx-00:00 login $ */
...
END XXPHA_eam536_PKG;
/
CREATE OR REPLACE PACKAGE BODY XXPHA_eam536_PKG IS
/* $Id: XX_eam536_PKG.sql 1.0 xx/xx/xxxx-00:00 login $ */
...
/*
   PROCEDURE xxpha_log( p_msg    IN VARCHAR2
    ...
    is
    BEGIN
        xxpha_pnaumov_pkg.gb_log_mark := 'eam536';
